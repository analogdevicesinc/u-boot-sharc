 ...
 * 0x092000 - 0x0D2000 : DTB	(256KiB)
 * 0x0D2000 - 0x5D2000 : ARGS	(5MB)
 * 0x5D2000 - 0x19D2000: Linux Kernel - zImage (20MB)
 * 0x19D2000 - 0x4000000: Linux Kernel - initramfs (38MB)
 */
/* Defines for SPL */
...
#define CONFIG_SYS_SPI_U_BOOT_SIZE  0x80000    /* 512KiB */
#define CONFIG_SYS_SPI_DTB_OFFS		0x92000    /* CONFIG_SYS_SPI_U_BOOT_OFFS + CONFIG_SYS_SPI_U_BOOT_SIZE */
#define CONFIG_SYS_SPI_DTB_SIZE		0x40000    /* 256KiB */
#define CONFIG_SYS_SPI_ARGS_OFFS	0xD2000    /* CONFIG_SYS_SPI_DTB_OFFS + CONFIG_SYS_SPI_DTB_SIZE */
#define CONFIG_SYS_SPI_ARGS_SIZE	0x500000  /* 5MB */
#define CONFIG_SYS_SPI_KERNEL_OFFS	0x5D2000  /* CONFIG_SYS_SPI_ARGS_OFFS + CONFIG_SYS_SPI_ARGS_SIZE */
#define CONFIG_SYS_SPI_KERNEL_SIZE	0x1400000  /* 20MB */
#define CONFIG_SYS_SPI_INITRAM_OFFS	0x19D2000  /* CONFIG_SYS_SPI_KERNEL_OFFS + CONFIG_SYS_SPI_KERNEL_SIZE */
